...
public class GetURLList {
    ...
    public static void main(String args[]) throws Exception {
        ...
        for(int i=1;i<=11;i++){
            if(i==1){
                url="http://zwgk.gz.gov.cn/GZ16/2.1/list1.shtml";
            }else {
                url="http://zwgk.gz.gov.cn/GZ16/2.1/list1_"+i+".shtml";
            }
            workurl(url,i);
    ...
    public static void workurl(String strurl,Integer page) throws Exception {
        File file = new File("C:\\Users\\张洲徽\\Desktop\\jiaotongweiyuanhui_page"+ File.separator+page+".html");
