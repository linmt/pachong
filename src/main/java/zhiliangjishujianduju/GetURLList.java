...
public class GetURLList {
    ...
    public static void main(String args[]) throws Exception {
        ...
        for(int i=1;i<=9;i++){
            if(i==1){
                url="http://www.gzq.gov.cn/gzq/2.3/common_list.shtml";
            }else {
                url="http://www.gzq.gov.cn/gzq/2.3/common_list_"+i+".shtml";
            }
            workurl(url,i);
    ...
    public static void workurl(String strurl,Integer page) throws Exception {
        File file = new File("C:\\Users\\张洲徽\\Desktop\\zhiliangjishujianduju_page"+ File.separator+page+".html");
