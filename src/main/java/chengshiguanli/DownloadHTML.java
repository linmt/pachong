...
public class DownloadHTML {
    ...
    public static String getLowidAndTitle(Integer page) throws IOException {
        String path="C:\\Users\\张洲徽\\Desktop\\chengshiguanli_hjws_page\\"+page+".html";
        Document doc = Jsoup.parse(readHtml(path));

        String msg=null;
        Elements elements = doc.select("#DIV1").select("tr");
        int count=0;
        try {
            for (Element e : elements) {
                count++;
//                System.out.println(e.text());
                //http://www.gzcgw.gov.cn/gzcgw/zhzf/201901/69e93043751c443b9a4cfc004f47bee3.shtml
                //../../gzcgw/zhzf/201901/69e93043751c443b9a4cfc004f47bee3.shtml
                String url=e.select("a").attr("href").replace("../../","http://www.gzcgw.gov.cn/");
...
//                System.out.println(title);
    ...
    public static void workurl(String strurl,String title) throws Exception {
        File file = new File("C:\\Users\\张洲徽\\Desktop\\chengshiguanli_hjws"+ File.separator+title+".html");
