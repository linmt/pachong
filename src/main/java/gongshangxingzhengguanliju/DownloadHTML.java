...
public class DownloadHTML {
    ...
    public static String getLowidAndTitle(Integer page) throws IOException {
        String path="C:\\Users\\张洲徽\\Desktop\\gongshangxingzhengguanliju_page\\"+page+".html";
        ...
        for (Element e : eles) {
            if(e.attr("class").equals("news_list")){
...
//                System.out.println(e.text());
                //http://www.gzaic.gov.cn/gzaic/zcfg_dfxfg/201811/b6b03967a2ff4083a9a9b7f8a48ad37c.shtml
                //../../gzaic/zcfg_dfxfg/201811/b6b03967a2ff4083a9a9b7f8a48ad37c.shtml
                String url=e.select("a").attr("href").replace("../../","http://www.gzaic.gov.cn/");
...
//                System.out.println(title);
    ...
    public static void workurl(String strurl,String title) throws Exception {
        File file = new File("C:\\Users\\张洲徽\\Desktop\\gongshangxingzhengguanliju"+ File.separator+title+".html");
