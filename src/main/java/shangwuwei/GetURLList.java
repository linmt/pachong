...
public class GetURLList {
    ...
    public static void main(String args[]) throws Exception {
        ...
        for(int i=1;i<=50;i++){
            if(i==1){
                url="http://www.gzboftec.gov.cn/gzboftec/xxgk_zcfg_xxfg/list.shtml";
            }else {
                url="http://www.gzboftec.gov.cn/gzboftec/xxgk_zcfg_xxfg/list_"+i+".shtml";
            }
            workurl(url,i);
    ...
    public static void workurl(String strurl,Integer page) throws Exception {
        File file = new File("C:\\Users\\张洲徽\\Desktop\\shangwuwei_page"+ File.separator+page+".html");
