...
public class GetURLList {
    ...
    public static void main(String args[]) throws Exception {
        ...
        for(int i=1;i<=19;i++){
            if(i==1){
                url="http://www.gzjjjc.gov.cn/gzsjw/flfg/list.shtml";
            }else {
                url="http://www.gzjjjc.gov.cn/gzsjw/flfg/list_"+i+".shtml";
            }
            workurl(url,i);
    ...
    public static void workurl(String strurl,Integer page) throws Exception {
        File file = new File("C:\\Users\\张洲徽\\Desktop\\jianchaju_page"+ File.separator+page+".html");
