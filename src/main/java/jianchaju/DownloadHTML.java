...
public class DownloadHTML {
    ...
    public static String getLowidAndTitle(Integer page) throws IOException {
        String path="C:\\Users\\张洲徽\\Desktop\\jianchaju_page\\"+page+".html";
        Document doc = Jsoup.parse(readHtml(path));

        String msg=null;
        Elements elements = doc.select(".tab_table6").select("li");
        int count=0;
        try {
            for (Element e : elements) {
                count++;
                //http://www.gzjjjc.gov.cn/gzsjw/dnfgzd/201308/2702686.shtml
                String url=e.select("a").attr("href").replace("../../","http://www.gzjjjc.gov.cn/");
    ...
    public static void workurl(String strurl,String title) throws Exception {
        File file = new File("C:\\Users\\张洲徽\\Desktop\\jianchaju"+ File.separator+title+".html");
