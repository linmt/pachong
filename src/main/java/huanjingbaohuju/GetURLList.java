...
public class GetURLList {
    ...
    public static void main(String args[]) throws Exception {
        ...
        for(int i=1;i<=6;i++){
            if(i==1){
                url="http://www.gzepb.gov.cn/zwgk/fgybz/index.htm";
            }else {
                url="http://www.gzepb.gov.cn/zwgk/fgybz/index_"+i+".htm";
            }
            workurl(url,i);
    ...
    public static void workurl(String strurl,Integer page) throws Exception {
        File file = new File("C:\\Users\\张洲徽\\Desktop\\huanjingbaohuju_page"+ File.separator+page+".html");
